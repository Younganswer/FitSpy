...
class TraineeHome(tk.Frame):
	...
	def	__set_buttons(self):
		...
		self.__find_trainer_button = ttk.Button(self, image=self.__find_trainer_image, style="RoundedButton.TButton", command=lambda: self.__controller.show_frame("FindTrainer"))
